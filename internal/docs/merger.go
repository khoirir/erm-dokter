...
// MergeOpenAPISpecs menggabungkan base.yaml dengan daftar konten file modular modules/*.yaml
// menjadi satu dokumen spesifikasi OpenAPI 3.1.0 utuh.
func MergeOpenAPISpecs(baseBytes []byte, moduleFiles [][]byte) ([]byte, error) {
	...
	// Pastikan node 'paths' tersedia di root
	pathsNode := findOrCreateMappingChild(rootMapping, "paths")

	// Pastikan node 'components' dan 'components.schemas' tersedia
