...
func TestLogger_DefaultAndOutputJSON(t *testing.T) {
	...
	// 1. Test Info formatting
	l.Info("Dokter %s berhasil login dengan id %d", "Handi", 101)
	...
	expectedMsg := "Dokter Handi berhasil login dengan id 101"
	...
	// Verify source points to this test file
