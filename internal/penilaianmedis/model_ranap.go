...
type DataPenilaianMedisRanap struct {
...
func (d *DataPenilaianMedisRanap) Sanitize() {
...
func (d *DataPenilaianMedisRanap) Validate(errs apperror.ValidationError) {
	if d.KeluhanUtama == "" {
...
type PenilaianMedisRanap struct {
	IdKunjungan string `json:"id_kunjungan"`
	NoRawat     string `json:"no_rawat"`
	KodeDokter  string `json:"kode_dokter"`
	NamaDokter  string `json:"nama_dokter"`

	DataPenilaianMedisRanap
}

type SimpanPenilaianMedisRanapRequest struct {
	NoRawat string `json:"no_rawat"`
	DataPenilaianMedisRanap
}

func (req *SimpanPenilaianMedisRanapRequest) Sanitize() {
	req.NoRawat = strings.TrimSpace(req.NoRawat)
	req.DataPenilaianMedisRanap.Sanitize()
}

func (req *SimpanPenilaianMedisRanapRequest) Validate() apperror.ValidationError {
	...
	req.DataPenilaianMedisRanap.Validate(errs)
	if len(errs) > 0 {
		return errs
	}
	return nil
...
type UpdatePenilaianMedisRanapRequest struct {
	DataPenilaianMedisRanap
}

func (req *UpdatePenilaianMedisRanapRequest) Sanitize() {
	req.DataPenilaianMedisRanap.Sanitize()
}

func (req *UpdatePenilaianMedisRanapRequest) Validate() apperror.ValidationError {
	errs := make(apperror.ValidationError)
