...
type Kontraksi string

const (
	KontraksiAda   Kontraksi = "Ada"
	KontraksiTidak Kontraksi = "Tidak"
)

func (k Kontraksi) IsValid() bool {
	switch k {
	case KontraksiAda, KontraksiTidak:
		return true
	default:
		return false
	}
...
type DataPenilaianMedisRalanKandungan struct {
...
func (d *DataPenilaianMedisRalanKandungan) Sanitize() {
...
func (d *DataPenilaianMedisRalanKandungan) Validate(errs apperror.ValidationError) {
	if d.KeluhanUtama == "" {
...
type PenilaianMedisRalanKandungan struct {
	IdKunjungan string `json:"id_kunjungan"`
	NoRawat     string `json:"no_rawat"`
	KodeDokter  string `json:"kode_dokter"`
	NamaDokter  string `json:"nama_dokter"`

	DataPenilaianMedisRalanKandungan
}

type SimpanPenilaianMedisRalanKandunganRequest struct {
	NoRawat string `json:"no_rawat"`
	DataPenilaianMedisRalanKandungan
}

func (req *SimpanPenilaianMedisRalanKandunganRequest) Sanitize() {
	req.NoRawat = strings.TrimSpace(req.NoRawat)
	req.DataPenilaianMedisRalanKandungan.Sanitize()
}

func (req *SimpanPenilaianMedisRalanKandunganRequest) Validate() apperror.ValidationError {
	...
	req.DataPenilaianMedisRalanKandungan.Validate(errs)
	if len(errs) > 0 {
		return errs
	}
	return nil
...
type UpdatePenilaianMedisRalanKandunganRequest struct {
	DataPenilaianMedisRalanKandungan
}

func (req *UpdatePenilaianMedisRalanKandunganRequest) Sanitize() {
	req.DataPenilaianMedisRalanKandungan.Sanitize()
}

func (req *UpdatePenilaianMedisRalanKandunganRequest) Validate() apperror.ValidationError {
	errs := make(apperror.ValidationError)
